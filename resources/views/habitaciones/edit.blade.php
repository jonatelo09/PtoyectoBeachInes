                    ...
                    <div class="col-md-9 register-right">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <h3 class="register-heading"> {{ $title_page }}  {{ $habitacion->nombre }}</h3>
                                         ...
                                         {{-- <div class="form-group">
                                           <div class="input-group">
                                             ...
                                             <select  name="id_categoria" id="id_categoria" class="form-control">
                                                ...
                                                @foreach ($habitacion->category_id as $categ)
 ...
 --}}
                                       ...
                                       {{--   <div class="form-group">
                                           <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Nombre" required="" value="{{ $habitacion->name }}">
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                        @php
                                            $arrayinc = json_decode($habitacion->incluye,true);
                                            //dd($arrayinc);
                                        @endphp
                                        @foreach($arrayinc as $hab)
                                           ...
                                           @endphp
                                        @endforeach
                                       {{--  @if ($habitacion->incluye=='Masculino')
                                         @php($hombre='checked')
                                         @php($mujer='')
                                         @else
                                 ...
                                 <button type="submit" class="redondo btn btn-info"><i class="fas fa-save"></i> Guardar</button>
                                    <a href="{{ route('cancelarh') }}" class="redondo btn btn-danger"><i class="fas fa-ban"></i> Cancelar</a>
