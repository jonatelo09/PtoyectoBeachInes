          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="form-group label-floating">
                ...
                <input type="text" class="form-control" id="cantidad_personas" name="cantidad_personas" required="">
          ...
          <div class="row">
            ...
            <div class="col-sm-6">
              <div class="form-group label-floating">
                ...
                <input type="text" class="form-control" id="cantidad_camas" name="cantidad_camas" required="">
