				...
				<div class="container mb-3">
					<div class="row py-2" style="background:#fff">
						<div class="col-6 col-md-3 input-group pr-1">
							<input type="text" class="form-control datepicker entrada" autocomplete="off" placeholder="Entrada" name="entry_date"  required>
		        ...
		        @if ( $disponibilidad == 0)
					<div class="col-12 col-lg-4 colDerReservas" {{-- style="display:none" --}}>
						...
						<div class="form-group">
						  ...
						  <input type="text" class="form-control" name="entry_date" value="{{ $date_inicio }}" readonly>
						</div>
						<div class="form-group">
						  <label>Salida 12:00 pm:</label>
						  <input type="text" class="form-control" name="departure_date" value="{{ $date_final }}"  readonly>
						</div>
						<div class="form-group">
