...
<body>
  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class=" border-right" id="sidebar-wrapper" style="background: #000">
      <div class="text-white sidebar-heading">Beach Hotel Ines</div>
      <div class="list-group list-group-flush">


                <div class="dropdown-divider"></div>
                <a class="dropdown-item fondo icono" href="{{-- {{ route('reservarhabitacion') }} --}}"><i class="fas fa-calendar-day"></i> Reservar</a>
                <div class="dropdown-divider"></div>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
            <li class="nav-item active">
              ...
              <a class="fondo2 nav-link" href="{{ route ('habitaciones')}}">HABITACIONES ESTÁNDAR</a>

            </li>

            <li class="nav-item active">

              <a class="fondo2 nav-link" href="{{ route ('departamentos')}}">DEPARTAMENTOS</a>
            </li>
            <li class="nav-item active">
              <a class="fondo2 nav-link" href="{{ route ('suites')}}">SUITES</a>

            </li>
            <li class="nav-item active">

                <a class="fondo2 nav-link" href="{{ route ('bungalows')}}">BUNGALOWS</a>
            ...
            <li class="nav-item dropdown estilo">
              <a class=" dropdown-toggle estilo nav-link" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="margin-left: 30px">
